...
public class CommentService {
    ...
    public void CreateComment(CommentDto commentDto){
        ...
        Message<String> message = MessageBuilder.withPayload(s)
                .setHeader(KafkaHeaders.TOPIC, TopicType.COMMENT_CREATED.getTopic())
                .build();
    ...
    public void UpdateComment(CommentDto commentDto,Long id){
        ...
        LOG.info(s);
        Message<String> message = MessageBuilder.withPayload(s)
                .setHeader(KafkaHeaders.TOPIC, TopicType.COMMENT_UPDATED.getTopic())
                .build();
        streamBridge.send(BindingName.COMMENT.getName(), message);
    }
    public void DeleteComment(Long id){
        ...
        LOG.info(s);
        Message<String> message = MessageBuilder.withPayload(s)
                .setHeader(KafkaHeaders.TOPIC, TopicType.COMMENT_DELETED.getTopic())
                .build();
        streamBridge.send(BindingName.COMMENT.getName(), message);
    }
